...
pub type PCNT1DIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, EM23PERNORETAINCTRL_SPEC, bool, O>;
...
pub type PCNT2DIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, EM23PERNORETAINCTRL_SPEC, bool, O>;
...
pub type IDAC0DIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, EM23PERNORETAINCTRL_SPEC, bool, O>;
...
pub type WDOG1DIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, EM23PERNORETAINCTRL_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pcnt1dis(&mut self) -> PCNT1DIS_W<3> {
        PCNT1DIS_W::new(self)
    }
    #[doc = "Bit 4 - Allow Power Down of PCNT2 During EM23"]
    #[inline(always)]
    #[must_use]
    pub fn pcnt2dis(&mut self) -> PCNT2DIS_W<4> {
        PCNT2DIS_W::new(self)
    }
    #[doc = "Bit 5 - Allow Power Down of I2C0 During EM23"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn idac0dis(&mut self) -> IDAC0DIS_W<8> {
        IDAC0DIS_W::new(self)
    }
    #[doc = "Bit 9 - Allow Power Down of ADC0 During EM23"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn wdog1dis(&mut self) -> WDOG1DIS_W<12> {
        WDOG1DIS_W::new(self)
    }
    #[doc = "Bit 13 - Allow Power Down of LESENSE0 During EM23"]
    #[inline(always)]
